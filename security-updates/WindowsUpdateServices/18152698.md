...
ms:contentKeyID: 18152698
ms:mtpsurl: 'https://technet.microsoft.com/sv-se/library/Cc720475(v=WS.10)'
---
...
| ![](images/Cc720475.note(WS.10).gif)Obs!                           |
|-------------------------------------------------------------------------------------------------|
...
| ![](images/Cc720475.Important(WS.10).gif)Viktigt! |
|--------------------------------------------------------------------------------|
